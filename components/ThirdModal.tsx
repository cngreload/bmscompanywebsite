    ...
    <div className="py-10  flex items-center justify-center overflow-y-visible scroll-my-2">
      <Modal>
        ...
        <ModalBody className='h-fit  dark:bg-slate-50 dark:text-black'>
          <ModalContent>
            <h4 className="text-lg md:text-2xl bg-white dark:bg-purple-600  text-neutral-600 dark:text-neutral-100 font-bold text-center mb-8">
            ...
            <div className="md:items-center lg:text-xs text-[8px]">
              <p>
                عدم اجرای طرح هوشمندسازی جایگاه‌های سوخت سی‌ان‌جی، به‌رغم بودجه و در دسترس بودن محصولات بومی، شگفت‌انگیز است. اصلی‌ترین دلیل این تأخیر، ناهماهنگی بین سیاست وارداتی مدیریت طرح و تأکید پدافند بر استفاده از محصولات بومی است. همچنین، عدم هماهنگی با شرکت‌های پرداختی و عدم حمایت از شرکت‌های دانش‌بنیان داخلی موانع جدی اجرا را ایجاد کرده است. این تأخیر، حوادث مرگبار و تهدید امنیت را به وجود آورده است. با این حال، مدیریت طرح انگیزه‌ای برای اجرای این طرح نشان نداده است. در حالی که شرکت ما سامانه بومی هوشمند را موفقانه اجرا کرده است، مدیریت طرح هنوز به گسترش آن پاسخ نداده است. این وضعیت ناترازی سبد سوخت و کاهش اعتماد عمومی را به وجود آورده است. امیدواریم با توجه به موفقیت های این سامانه، مدیریت طرح در نهایت تصمیم به اجرا بگیرد تا به حفظ امنیت و بهبود کیفیت خدمات در عرصه سوخت گاز طبیعی بپردازد.
              </p>
            </div>
          </ModalContent>
