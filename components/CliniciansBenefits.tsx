        ...
        <div className="relative bg-gradient-to-bottom  text-black py-16 px-4 md:px-8 lg:px-12 flex flex-col items-center text-center overflow-x-hidden">
            ...
            <div className="text-center p-6 lg:p-10">
                ...
                <p className="text-sm sm:text-base lg:text-lg max-w-3xl mx-auto leading-relaxed">
                    کلینیکانز با ترکیبی از فناوری پیشرفته و طراحی کاربرمحور، راه‌حلی جامع ارائه می‌دهد که نه‌تنها فرآیندهای اداری را ساده می‌کند، بلکه مراقبت از بیماران را نیز بهبود می‌بخشد. <br />
                    از زمان‌بندی هوشمند و مدیریت ایمن داده‌ها گرفته تا تعامل با بیماران و پیش‌بینی مالی دقیق، کلینیکانز یک ابزار همه‌جانبه است که به کلینیک‌ها کمک می‌کند با کارایی و نظم بیشتری فعالیت کنند.
                </p>
            </div>
