...
const ThreeCircleTech: React.FC = () =>
{
    ...
    useEffect( () =>
    {
        ...
        const createScene = () =>
        {
            ...
            svgs.forEach( ( svg, index ) =>
            {
                ...
                const isSmallScreen = window.innerWidth <= 768;
                const iconSize = isSmallScreen ? 1.5 : 2; // Bigger for larger screens
            ...
            const animate = () =>
            {
                svgMeshes.forEach( ( mesh, i ) =>
                {
                    ...
                    const time = ( Date.now() / 8000 + i / svgMeshes.length ) % 1; // Slowed down rotation
    ...
    }, [] ); // Empty dependency array since 'svgs' is now defined inside
