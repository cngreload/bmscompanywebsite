          ...
          <ModalContent>
            ...
            <div>
              ...
              <div className="-m-2 md:-m-4">
                <p className="text-sm">
                  هوشمندسازی جایگاه‌های عرضه سوخت گاز طبیعی، گامی مهم در راستای تامین ایمنی تردد خودروهای دوگانه‌سوز و حفظ جان شهروندان است. هیات وزیران در جلسه‌ای در اسفندماه 1397، تصویب‌نامه‌ای را به پیشنهاد وزارت کشور و به استناد اصل یکصد و سی و هشتم قانون اساسی جمهوری اسلامی ایران به تصویب رساند. این تصویب‌نامه بر لزوم هوشمندسازی جایگاه‌های عرضه سوخت گاز طبیعی تاکید دارد و وزارت نفت را موظف به همکاری با وزارت صنعت، معدن و تجارت برای ایجاد بستری جهت اتصال سامانه هوشمند جایگاه‌های سوخت به سامانه یکپارچه معاینه فنی ایران (سیمفا) و سامانه اطلاعات خودروهای گازسوز می‌کند. این اقدامات با هدف تامین ایمنی تردد خودروهای دوگانه‌سوز انجام می‌شود و از سال 1398، سوخت‌گیری در جایگاه‌های سوخت گاز طبیعی تنها برای خودروهای دوگانه‌سوز دارای گواهی معاینه فنی معتبر امکان‌پذیر خواهد بود. این مصوبه همچنین بر نقش پلیس راهنمایی و رانندگی نیروی انتظامی در اصلاح و تعویض مدارک شناسایی خودروهای دوگانه‌سوز کارگاهی تاکید دارد و مالکان این خودروها را ملزم به اخذ گواهی سلامت سامانه سوخت‌رسانی گاز خودرو می‌کند. سازمان ملی استاندارد ایران نیز موظف به تدوین استانداردهای لازم برای تبدیل سامانه سوخت‌رسانی خودروهای مایع‌سوز به گازسوز است. این مصوبه با افزایش نرخ سوخت گاز طبیعی فشرده (سی‌ان‌جی)، به تامین منابع مالی اجرای الزامات ایمنی و هوشمندسازی جایگاه‌های عرضه سی‌ان‌جی و تعویض مخازن وسایل نقلیه کمک می‌کند.
                </p>
              </div>
            </div>
          </ModalContent>
