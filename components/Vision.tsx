        ...
        <div className="bg-white text-black py-16 px-4 sm:px-8 overflow-x-hidden">
            ...
            <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-sm sm:text-lg mt-6 text-gray-900 leading-relaxed">
                    ما در بارمان محور اسپادانا پرورش دهنده چشم انداز تحقق رویایی انسان مدرن برای زیر انگشت داشتن تمامی فعالیت های کسب و کار و املاک خود با دقت و امن، از هرنقطه و در هر لحظه بلادرنگ، می باشیم.
                    این نوید بخش عصر نوین هوشمندسازی و اتماسیون در ساختار صنتعت چهارم و ادغام آن در زندگی مردم می باشد.
                </p>
            </div>
            ...
            <div className="max-w-5xl mx-auto mt-16 bg-slate-400 rounded-2xl p-6 sm:p-8 flex flex-col space-y-6">
                <div className="flex flex-col space-y-4 text-justify">
                    <p className="text-sm sm:text-lg leading-relaxed">
                        با هدف ارتقای هوشمندسازی در طیف وسیعی از منازل، کسب‌وکارها و صنایع سامانه‌ای بومی و منحصربه‌فرد به نام سامانه هوشمند کنترل و تگ را از پایه طراحی و تولید کرده است. این سامانه که تجلی نوآوری و فناوری‌های پیشرفته است، در دو بخش جامع سخت‌افزاری و نرم‌افزاری ارائه می‌شود. هر بخش از این سامانه شامل محصولات تخصصی متعددی است که به‌طور یکپارچه به بهینه‌سازی فرآیندهای هوشمندسازی کمک می‌کنند.
                    </p>
                    <p className="text-sm sm:text-lg leading-relaxed">
