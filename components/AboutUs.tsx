        ...
        description: (
            <div className="h-full w-full bg-gradient-to-br from-cyan-500 to-emerald-500 flex items-center justify-center text-white p-4 text-sm sm:text-base md:text-lg lg:text-xl">
                <p>
                    ...
                    <br />
                    <br />
                    با چشم‌انداز ارائه محصولی کامل، نوین، و منحصر به فرد با اتکا به توان داخلی، سامانه هوشمند کنترل و تگ توسعه یافت تا دسترسی به فناوری هوشمندسازی برای طیف وسیعی از کسب‌وکارها و صنایع کشور فراهم شود.
                    <br />
                    <br />
